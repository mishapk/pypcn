...
def insertDB():
    ...
    sql.append('INSERT INTO sensor(address,x,y,info,title,type_id,sounds,commands)VALUES(162,717,259,"Место хранеия кислоты","U2.2",2,"|tv_vitikkislotyVK.wav|error.wav|chimes.wav","");')
    sql.append('INSERT INTO sensor(address,x,y,info,title,type_id,sounds,commands)VALUES(163,273,247,"Травильные ванны","U2.3",2,"|tv_vitikkislotyTV.wav|error.wav|chimes.wav","");')
    sql.append('INSERT INTO sensor(address,x,y,info,title,type_id,sounds,commands)VALUES(164,120,222,"Травильные ванны","U2.4",2,"|tv_vitikkislotyTV.wav|error.wav|chimes.wav","");')
    sql.append('INSERT INTO sensor(address,x,y,info,title,type_id,sounds,commands)VALUES(165,585,327,"Место хранеия кислоты","VTM1",6,"|tv_ns.wav|error.wav|chimes.wav","");')
    sql.append('INSERT INTO sensor(address,x,y,info,title,type_id,sounds,commands)VALUES(166,30,217,"Травильные ванны","VTM2",6,"|tv_ns.wav|error.wav|chimes.wav","");')
    sql.append('INSERT INTO sensor(address,x,y,info,title,type_id,sounds,commands)VALUES(167,30,264,"Травильные ванны","VTM3",6,"|tv_ns.wav|error.wav|chimes.wav","");')
    sql.append('INSERT INTO sensor(address,x,y,info,title,type_id,sounds,commands)VALUES(168,690,350,"Место хранеия кислоты","U3.1",5,"kpk1.wav|kpk2.wav|error.wav|chimes.wav","");')
    sql.append('INSERT INTO sensor(address,x,y,info,title,type_id,sounds,commands)VALUES(168,640,350,"Место хранеия кислоты","U3.2",5,"kpk1.wav|kpk2.wav|error.wav|chimes.wav","");')
